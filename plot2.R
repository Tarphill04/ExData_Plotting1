...
#plot Global Active Power on Thursday and Friday with y label but no x label or main title.
plot(febpow$Time, febpow$Global_active_power, xlab="", ylab="Global Active Power (kilowatts)", type="l")
